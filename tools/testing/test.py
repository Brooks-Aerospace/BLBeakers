...
# test wingload
WSs, _ = wing.wingload(itertows)
# print(WSs[0])

# test groundroll
ToL = np.array(wing.groundroll(WSs, 0.3548, [1.89, 2.1], 0))
# print(ToL)

# test psc gen
fuse = fuse.fuse()
plt.figure()
PSCyl = fuse.PSCylGen(7, 11.5, [0.3, 0.2], 0.6)
Swet, Drag, Cd0 = fuse.PSCylDrag(PSCyl, 0.82, 37500, 714.3)
print(Swet)
print(Drag)
print(Cd0)
